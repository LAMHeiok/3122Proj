...
if writing_type == "Narrative":
    ...
    example_sentence = "Photosaaaaaaaaaaahesis is the process by which green plants use sunlight to synthesize foods with the help of chlorophyll."
